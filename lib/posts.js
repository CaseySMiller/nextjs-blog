...
// ./posts is the directory where the markdown files are stored for static site generation
...
export function getSortedPostsData() {
  ...
  // Sort posts by date
  // returns an array of objects sorted by date with {id, date, title}
...
export async function getPostData(id) {
  ...
  // Combine the data with the id and return {id, contentHtml, date, title}
  return {
    id,
    contentHtml,
    ...matterResult.data,
